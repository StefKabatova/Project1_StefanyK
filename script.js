$(document).ready(function(){
  ...
  let entertainment_data = [{
    question: "Which film had a worldwide box-office gross income of over $2.7billion? ",
    choices: ["Titanic","Lion King","Jurassic Park","Avatar"],
    answer: "Avatar"
  },{
    question:"Which actress has been nominated for an Academy Award more than 19 times, and has won the award more than 3 times?",
  ...
  let geo_data = [{
    ...
    {
      question: "Where is the Bora Bora island located?",
...
// function retrieves data for: question, answer choices, and answer.
  ...
  function game_checker(answer){
    if (answer == correct_answer){
      ...
      $("#question").text("INCORRECT! "+ "The Correct answer is :"  + " " + correct_answer)
      // points -=50
    }
